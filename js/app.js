...
function guardarCliente() {
    ...
    //Asignar datos del formumario al cliente
...
function obtenerPlatillos() {
    const url = 'http://localhost:4004/platillos'
...
function agregarPlatillo(producto) {
    ...
    if (producto.cantidad > 0) {
        ...
        if (pedido.some(articulo => articulo.id === producto.id)) {
            ...
            // Se asigla el nuevo array a cliente.pedido
...
function actualizarResumen() {
    ...
    pedido.forEach(articulo => {
        ...
        const subotalEl = document.createElement('p')
        subotalEl.classList.add('fw-bold')
        subotalEl.textContent = 'Subtotal: '
        ...
        subotalEl.appendChild(subtotalValor)
...
function calcularPropina() {
    ...
    // Calcular el subtotal con propina a pagar
